...
The system asks the player if he wants to set a Timer (y/n).
The player set Timer and set seconds for Timer or declines to select.
...
If the player is alive, he enters his actions through the interface (possible commands: pass, call, raise, allin, act).
