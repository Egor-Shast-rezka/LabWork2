...
The shuffle method randomly shuffles the deck using a shuffling algorithm.
The deal method returns one card from the deck, and the putOneCardInDeck method allows you to add cards back to the deck.
